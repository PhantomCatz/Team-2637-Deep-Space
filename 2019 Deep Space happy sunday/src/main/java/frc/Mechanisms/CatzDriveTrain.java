...
{     
    ...
    *****************************************************************************/
    ...
    private static DoubleSolenoid drvTrainClimberA;

    private static Solenoid drvTrainClimberB;
    ...
    private static final int DRVTRAIN_CLIMBER_SOLENOID_B_PCM_PORT = 5;
    ...
    {  
        ...
        */
        ...
        drvTrainMtrCtrlRTMidl.burnFlash();
        drvTrainMtrCtrlRTFrnt.burnFlash();
        drvTrainMtrCtrlLTBack.burnFlash();
        drvTrainMtrCtrlLTMidl.burnFlash();
        ...
        drvTrainClimberA = new DoubleSolenoid(DRVTRAIN_CLIMBER_SOLENOID_A_PCM_PORT_A, DRVTRAIN_CLIMBER_SOLENOID_A_PCM_PORT_B);
        drvTrainClimberB = new Solenoid(DRVTRAIN_CLIMBER_SOLENOID_B_PCM_PORT);
    ...
    public void deployClimberFront()
    {
        drvTrainClimberA.set(Value.kReverse);
    }

    public void deployClimberBack()
    {
        drvTrainClimberB.set(true);
    }

    public void retractClimberFront()
    {
        drvTrainClimberA.set(Value.kForward);
    }

    public void retractClimberBack()
    {
        drvTrainClimberB.set(false);
    }

    public boolean getDriveTrainSolenoidState()
    {
        return drvTrainClimberB.get();
    }

    public int getDrvTrainMtrCtrlLTFrntFirmware()
    {
        return drvTrainMtrCtrlLTFrnt.getFirmwareVersion();
    }

    public int getDrvTrainMtrCtrlLTMidlFirmware()
    {
        return drvTrainMtrCtrlLTMidl.getFirmwareVersion();
    }

    public int getDrvTrainMtrCtrlLTBackFirmware()
    {
        return drvTrainMtrCtrlLTBack.getFirmwareVersion();
    }

    public int getDrvTrainMtrCtrlRTFrntFirmware()
    {
        return drvTrainMtrCtrlRTFrnt.getFirmwareVersion();
    }

    public int getDrvTrainMtrCtrlRTMidlFirmware()
    {
        return drvTrainMtrCtrlRTMidl.getFirmwareVersion();
    }

    public int getDrvTrainMtrCtrlRTBackFirmware()
    {
        return drvTrainMtrCtrlRTBack.getFirmwareVersion();
    }
}